<x-app-layout>
                    ...
                    <div class="detail-section">
                        ...
                        <div class="detail-grid">
                            ...
                            <div>
                                ...
                                {{-- === FORM UPDATE STATUS === --}}
                                <form action="{{ route('admin.pesanan.update', ['orderId' => $order->id]) }}" method="POST" class="update-status-form" id="updateStatusForm">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <button type="submit" class="btn btn-primary px-4 py-2 text-sm" id="submitBtn">Update Status</button> {{-- Ukuran tombol lebih kecil --}}
                                </form>
    ...
    {{-- JavaScript untuk handle CSRF token dan form submission --}}
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    // Disable button untuk prevent double submission
                    if (submitBtn) {
                ...
                // Refresh CSRF token setiap kali halaman dimuat
            ...
            // Handle jika ada error 419 dari response sebelumnya
            // Cek URL untuk parameter error
